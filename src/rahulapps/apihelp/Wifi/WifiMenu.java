...
public class WifiMenu extends Activity implements OnItemClickListener
{
	ListView lv;
	ArrayAdapter<String> arrayadapter;
	
	String sMenu[]={"1) Wifi API","2) Wifi Program"};
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		arrayadapter = new ArrayAdapter<String>(WifiMenu.this,android.R.layout.simple_list_item_1,sMenu);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) 
	{
		...
		switch(position)
		{
		case 0:ActivityStarter("rahulapps.apihelp.Wifi.WifiAPI");break;
		case 1:ActivityStarter("rahulapps.apihelp.Wifi.WifiCode");break;
		}
	}
