...
public class TanMenu extends Activity implements OnItemClickListener
{
	ListView lv;
	ArrayAdapter<String> arrayadapter;
	
	String sMenu[]={"Tan Curve"," Tan Program"};
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		arrayadapter = new ArrayAdapter<String>(TanMenu.this,android.R.layout.simple_list_item_1,sMenu);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) 
	{
		...
		switch(position)
		{
		case 0:ActivityStarter("rahulapps.apihelp.Graphs.Tan");break;
		case 1:ActivityStarter("rahulapps.apihelp.Graphs.TanCode");break;
