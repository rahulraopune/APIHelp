...
public class SineMenu extends Activity implements OnItemClickListener
{
	ListView lv;
	ArrayAdapter<String> arrayadapter;
	
	String sMenu[]={"Sine Curve"," Sine Program"};
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		arrayadapter = new ArrayAdapter<String>(SineMenu.this,android.R.layout.simple_list_item_1,sMenu);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) 
	{
		...
		switch(position)
		{
		case 0:ActivityStarter("rahulapps.apihelp.Graphs.Sine");break;
		case 1:ActivityStarter("rahulapps.apihelp.Graphs.SineCode");break;
